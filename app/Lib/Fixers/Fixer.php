...
class Fixer {
    ...
    public function __construct($filename, $stdr)
    {
        ...
        if(is_file($this->projectDir.'/'.$filename) || is_dir($this->projectDir.'/'.$filename)) {
            ...
            $this->reportDir = $this->projectDir.'/phpqa/report';
    ...
    public function phpcsfixer(){
        ...
        if(is_file($this->phpcsfixer)){
            ...
            try {
                ...
                return  '<h2>Before</h2>'.$cs.'<h2>Fixer</h2>'.$csfixer.'<h2>After</h2>'.$csAfter;
    ...
    public  function chackFile(){
        ...
        if(!$this->getFile()) {
            ...
            return [false,'<div class="alert alert-danger" role="alert"><b>Ooops :</b>
            File not exist </div>'];
             
        }else{
        
            return [true,'<div class="alert alert-success" role="alert">
